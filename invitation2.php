    ...
    if (strtolower(trim($_POST['Userkey'])) == '') {
          ...
          $hasError2 = true;
		   ...
		   // open connection to PROD Server BETA
			...
			$sql = "insert into register_alpha_flyer(remote_address,regcreated) values ('$remote',now())";
...
<div class="logo" style="padding-bottom:20px;"><a href="#"><img src="images/logo.jpg" alt="" width="443" height="232" border="0" /></a></div>
  ...
  <?php if ($hasError1 == 'true') { //If errors are found ?>  
	...
	<div class="key2">
		<span class="white">Don't have a GoalFace key?</span>&nbsp;<span class="orange"><a href="http://www.goalface.com/register.html">Click here to get one.</a></span>
	</div>
  </div>
